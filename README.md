...
<p align="center">
  <img
    src="https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,nodejs,express,python,java,cpp,tailwind,redux,mongodb,mysql,postgres,redis,firebase,docker,git,github,figma,vercel,aws,gcp&perline=18&size=22"
    alt="Tech Stack"
  />
</p>
